...
class Csfirstyear extends StatefulWidget {
  @override
  _CsfirstyearState createState() => _CsfirstyearState();
}

class _CsfirstyearState extends State<Csfirstyear> {
  ...
  Future<void> fetchAttendanceByDate(String date) async {
    ...
    await _firestore.collection("CS1styear").doc(date).get();
