...
class Paintfirstyear extends StatefulWidget {
  @override
  _PaintfirstyearState createState() => _PaintfirstyearState();
}

class _PaintfirstyearState extends State<Paintfirstyear> {
  ...
  Future<void> fetchAttendanceByDate(String date) async {
    ...
    await _firestore.collection("Paintfirst").doc(date).get();
