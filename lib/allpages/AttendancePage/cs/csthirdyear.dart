...
class Csthirdyear extends StatefulWidget {
  @override
  _CsthirdyearState createState() => _CsthirdyearState();
}

class _CsthirdyearState extends State<Csthirdyear> {
  ...
  Future<void> fetchAttendanceByDate(String date) async {
    ...
    await _firestore.collection("CS3rdyear").doc(date).get();
