...
class _MechthirdState extends State<Mechthird> {
  ...
  List<Map<String, dynamic>> students = [
    ...
    {"id": 14, "name": "Kamal S. Supyal", "status": "Absent"},
    ...
    {"id": 31, "name": "Shankar S. Bhandari", "status": "Absent"},
    ...
    {"id": 38, "name": "Sawan S. Tadiyal", "status": "Absent"},
    {"id": 39, "name": "Rohit S. Bisht", "status": "Absent"},
    {"id": 40, "name": "Deepshikha Mehar", "status": "Absent"},
    {"id": 41, "name": "Ashish K. Pandey", "status": "Absent"},
