...
class Paintsecondyear extends StatefulWidget {
  @override
  _PaintsecondyearState createState() => _PaintsecondyearState();
}

class _PaintsecondyearState extends State<Paintsecondyear> {
  ...
  Future<void> fetchAttendanceByDate(String date) async {
    ...
    await _firestore.collection("Paintsecond").doc(date).get();
