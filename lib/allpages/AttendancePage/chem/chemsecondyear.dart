...
class Chemsecondyear extends StatefulWidget {
  @override
  _ChemsecondyearState createState() => _ChemsecondyearState();
}

class _ChemsecondyearState extends State<Chemsecondyear> {
  ...
  Future<void> fetchAttendanceByDate(String date) async {
    ...
    await _firestore.collection("Chemsecond").doc(date).get();
