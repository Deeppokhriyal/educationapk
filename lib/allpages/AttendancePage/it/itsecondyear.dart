...
class Itsecondyear extends StatefulWidget {
  @override
  _ItsecondyearState createState() => _ItsecondyearState();
}

class _ItsecondyearState extends State<Itsecondyear> {
  ...
  Future<void> fetchAttendanceByDate(String date) async {
    ...
    await _firestore.collection("attendance2ndyear").doc(date).get();
