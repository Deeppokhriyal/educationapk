...
class Agrisecondyear extends StatefulWidget {
  @override
  _AgrisecondyearState createState() => _AgrisecondyearState();
}

class _AgrisecondyearState extends State<Agrisecondyear> {
  ...
  Future<void> fetchAttendanceByDate(String date) async {
    ...
    await _firestore.collection("Agrisecond").doc(date).get();
