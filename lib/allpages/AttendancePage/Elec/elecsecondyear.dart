...
class Elecsecondyear extends StatefulWidget {
  @override
  _ElecsecondyearState createState() => _ElecsecondyearState();
}

class _ElecsecondyearState extends State<Elecsecondyear> {
  ...
  Future<void> fetchAttendanceByDate(String date) async {
    ...
    await _firestore.collection("Elecsecond").doc(date).get();
