...
class Civilsecondyear extends StatefulWidget {
  @override
  _CivilsecondyearState createState() => _CivilsecondyearState();
}

class _CivilsecondyearState extends State<Civilsecondyear> {
  ...
  Future<void> fetchAttendanceByDate(String date) async {
    ...
    await _firestore.collection("Civilsecond").doc(date).get();
