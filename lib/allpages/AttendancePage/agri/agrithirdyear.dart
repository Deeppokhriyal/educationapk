...
class Agrithirdyear extends StatefulWidget {
  @override
  _AgrithirdyearState createState() => _AgrithirdyearState();
}

class _AgrithirdyearState extends State<Agrithirdyear> {
  ...
  Future<void> fetchAttendanceByDate(String date) async {
    ...
    await _firestore.collection("Agrithird").doc(date).get();
