                            ...
                            Container( padding: EdgeInsets.all(20),
                              child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      Text(' Developer\'s Profile : ', style: TextStyle(fontFamily: 'nexalight',fontSize: 20,color: Colors.greenAccent,letterSpacing: 1,wordSpacing: 1),),
                                      GestureDetector(
                                        child: Image.asset('assets/images/tap1.png',height: 20,width: 20,),
                                      ),
                                    ],
                                  ),
                                  Divider(),
