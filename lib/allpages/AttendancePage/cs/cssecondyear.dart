...
class Cssecondyear extends StatefulWidget {
  @override
  _CssecondyearState createState() => _CssecondyearState();
}

class _CssecondyearState extends State<Cssecondyear> {
  ...
  Future<void> fetchAttendanceByDate(String date) async {
    ...
    await _firestore.collection("CS2ndyear").doc(date).get();
