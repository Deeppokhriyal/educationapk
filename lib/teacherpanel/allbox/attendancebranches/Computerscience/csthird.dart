...
class _CsthirdState extends State<Csthird> {
  ...
  List<Map<String, dynamic>> students = [
    ...
    {"id": 17, "name": "Lucky S. Bora", 'status': 'Absent'},
    {"id": 18, "name": "Madhumita", 'status': 'Absent'},
    {"id": 19, "name": "Manish S. Bisht", 'status': 'Absent'},
    {"id": 20, "name": "Mayank Negi", 'status': 'Absent'},
    {"id": 21, "name": "Mohd Ayan Ansari", 'status': 'Absent'},
    {"id": 22, "name": "Mukesh C. Arya", 'status': 'Absent'},
    ...
    {"id": 35, "name": "Rahul S. Patwal", 'status': 'Absent'},
