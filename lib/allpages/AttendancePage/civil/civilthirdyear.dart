...
class Civilthirdyear extends StatefulWidget {
  @override
  _CivilthirdyearState createState() => _CivilthirdyearState();
}

class _CivilthirdyearState extends State<Civilthirdyear> {
  ...
  Future<void> fetchAttendanceByDate(String date) async {
    ...
    await _firestore.collection("Civilthird").doc(date).get();
