...
class Mechthirdyear extends StatefulWidget {
  @override
  _MechthirdyearState createState() => _MechthirdyearState();
}

class _MechthirdyearState extends State<Mechthirdyear> {
  ...
  Future<void> fetchAttendanceByDate(String date) async {
    ...
    await _firestore.collection("MechThird").doc(date).get();
