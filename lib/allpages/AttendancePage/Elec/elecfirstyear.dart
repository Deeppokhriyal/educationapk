...
class Elecfirstyear extends StatefulWidget {
  @override
  _ElecfirstyearState createState() => _ElecfirstyearState();
}

class _ElecfirstyearState extends State<Elecfirstyear> {
  ...
  Future<void> fetchAttendanceByDate(String date) async {
    ...
    await _firestore.collection("Elecfirst").doc(date).get();
