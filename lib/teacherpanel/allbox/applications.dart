                ...
                Center(
                  child: Column(
                    children: [
                      ...
                      Text('No Application\'s Available',style: TextStyle(color: Colors.black,fontSize: 25,fontFamily: 'nexaheavy'),),
                      SizedBox(height: 10),
                      Text(
                        'Currently, there are no application\'s in the teacher application panel.',textAlign: TextAlign.center,style: TextStyle(color: Colors.black,fontSize: 20,fontFamily: 'nexalight'),
                      ...
                      ElevatedButton(
                        ...
                        child: Row(mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            Text('Explore more Feature\'s',style: TextStyle(color: Colors.purple,fontFamily: 'nexaheavy',fontSize: 17),),
                          ],
                        ),),
                    ],
                  ),
