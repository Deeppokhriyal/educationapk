...
class Pharmacysecondyear extends StatefulWidget {
  @override
  _PharmacysecondyearState createState() => _PharmacysecondyearState();
}

class _PharmacysecondyearState extends State<Pharmacysecondyear> {
  ...
  Future<void> fetchAttendanceByDate(String date) async {
    ...
    await _firestore.collection("Pharmacysecond").doc(date).get();
